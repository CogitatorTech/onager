...
void RegisterLinkFunctions(ExtensionLoader &loader) {
  ...
  ONAGER_SET_NO_ORDER(adamic_adar);
  ...
  ONAGER_SET_NO_ORDER(pref_attach);
  ...
  ONAGER_SET_NO_ORDER(resource_alloc);
  ...
  ONAGER_SET_NO_ORDER(common_neighbors);
